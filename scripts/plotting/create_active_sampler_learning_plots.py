...
PLOT_GROUPS = {
    ...
    # ],
    "Bumpy Cover": [
        ("KNN", "black", lambda df: df["EXPERIMENT_ID"].apply(
            lambda v: "bumpy_cover-teacher_with_knn" in v)),
        ("MLP", "red", lambda df: df["EXPERIMENT_ID"].apply(
            lambda v: "bumpy_cover-teacher_with_mlp" in v)),
    ],
}
