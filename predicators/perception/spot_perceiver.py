...
from predicators.spot_utils.utils import _container_type, _dustpan_type, \
    _immovable_object_type, _juicer_type, _movable_object_type, _robot_type, \
    _table_type, _trash_can_type, _wrappers_type, get_allowed_map_regions, \
...
class SpotPerceiver(BasePerceiver):
    ...
    def _create_goal(self, state: State,
        ...
        if goal_description == "make some juice!":
            ...
            pink_solid_plastic_cup = Object("pink_solid_plastic_cup", _container_type)
            juice_machine = Object("juice_machine", _juicer_type)
            robot = Object("robot", _robot_type)
            goal = {
                GroundAtom(JuiceInCup, [pear, clear_acrylic_plastic_cup_with_blue_tape]),
